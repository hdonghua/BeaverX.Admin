...
public sealed class RecurringCronUpdateDispatcher : IDashboardDispatcher
{
    public async Task Dispatch(DashboardContext context)
    {
        ...
        var cronExpression = form["cron"].ToString();

        try
        {
            var service = httpContext.RequestServices.GetRequiredService<Scheduling.IRecurringJobCronService>();
            await service.UpdateCronAsync(recurringJobId, cronExpression, httpContext.RequestAborted);
